      ...
      {isAlertModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-slate-900 w-full max-w-4xl h-[85vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden border border-gray-100 dark:border-slate-800 animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex justify-between items-center bg-white/50 dark:bg-slate-900/50 backdrop-blur-md flex-shrink-0">
              <div>
            ...
            <div className="flex-1 p-6 overflow-y-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 bg-gray-50/50 dark:bg-slate-950/50 content-start auto-rows-max">
              {lowStockItems.map((item) => (
                <button
                  key={item.uniqueKey}
                  onClick={() => handleAlertClick(item.sku, item.variantSize)}
                  className="flex items-start gap-4 p-4 rounded-2xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-600 hover:shadow-lg hover:-translate-y-1 transition-all text-left group relative overflow-visible h-fit"
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-start gap-2 pt-0">
                    <div className="flex items-center gap-2">
                      <span className="bg-rose-100 dark:bg-rose-900/40 text-rose-700 dark:text-rose-300 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider whitespace-nowrap">
                        Low Stock
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-2 text-xs">
                      <span className="font-mono text-gray-500 dark:text-slate-500 truncate">
                        {item.sku}
                      </span>
