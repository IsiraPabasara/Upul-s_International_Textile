                ...
                {preview ? (
                  <>
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 bg-white dark:bg-slate-800 text-gray-500 hover:text-white hover:bg-red-500 p-2 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all hover:scale-110 active:scale-95 z-10"
                      title="Remove Image"
                    >
                      <X size={18} strokeWidth={3} />
                    </button>
            ...
            >
              <div className="absolute top-2 right-2 flex gap-1 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity z-10">
                ...
                <button
                  ...
                  className="p-1.5 text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all active:scale-95 disabled:opacity-50"
                  title="Delete Brand"
                >
